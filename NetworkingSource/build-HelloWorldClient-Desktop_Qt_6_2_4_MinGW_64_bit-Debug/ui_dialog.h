...
public:
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        label->setText(QCoreApplication::translate("Dialog", "<html><head/><body><p>IP Address</p></body></html>", nullptr));
        label_2->setText(QCoreApplication::translate("Dialog", "<html><head/><body><p>Port</p></body></html>", nullptr));
        pushButtonConnect->setText(QCoreApplication::translate("Dialog", "Connect", nullptr));
        label_3->setText(QCoreApplication::translate("Dialog", "<html><head/><body><p>Message</p></body></html>", nullptr));
        pushButtonSend->setText(QCoreApplication::translate("Dialog", "Send", nullptr));
    } // retranslateUi
