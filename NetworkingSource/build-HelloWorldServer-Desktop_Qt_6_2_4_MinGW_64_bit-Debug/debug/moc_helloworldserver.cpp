...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_HelloWorldServer_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_HelloWorldServer_t qt_meta_stringdata_HelloWorldServer = {
    {
QT_MOC_LITERAL(0, 16), // "HelloWorldServer"
...
const QMetaObject HelloWorldServer::staticMetaObject = { {
    QMetaObject::SuperData::link<QTcpServer::staticMetaObject>(),
    qt_meta_stringdata_HelloWorldServer.offsetsAndSize,
    qt_meta_data_HelloWorldServer,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_HelloWorldServer_t
, QtPrivate::TypeAndForceComplete<HelloWorldServer, std::true_type>
