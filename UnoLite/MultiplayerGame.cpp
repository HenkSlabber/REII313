...
void MultiplayerGame::initCards()
{
    Card *c;
    for (int i = 0; i < 10; ++i)
    {
...
void MultiplayerGame::dealCards()
{
...
void MultiplayerGame::shuffleDeck()
{
    QList<Card*> newDeck;
    while(deck.length() > 0)
...
void MultiplayerGame::showArrangeHands()
{
    hideAll();
    Card *c;
    int i = 0;
...
void MultiplayerGame::cardClick(Card *c)
{
...
void MultiplayerGame::computerMove()
{
    if (stack.length() > 22)
    {
        for (int i = 0; i < 20; ++i)
...
Colour MultiplayerGame::calc4Colour()
{
    int nR, nG, nY, nB;
    nR = nG = nY = nB = 0;
    QListIterator<Card*> computerHandIterator(computerHand);
...
void MultiplayerGame::debug(QString s)
{
