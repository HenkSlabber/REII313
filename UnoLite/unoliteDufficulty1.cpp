...
UnoLiteDufficulty1::UnoLiteDufficulty1(QWidget *parent)
    : QMainWindow(parent)
{
...
UnoLiteDufficulty1::~UnoLiteDufficulty1()
{
}

void UnoLiteDufficulty1::initCards()
{
    Card *c;
    for (int i = 0; i < 10; ++i)
    {
...
void UnoLiteDufficulty1::dealCards()
{
...
void UnoLiteDufficulty1::hideAll()
{
...
void UnoLiteDufficulty1::showDeck()
{
    int x = 0;
    int y = 0;
    QListIterator<Card*> deckIterator(deck);
...
void UnoLiteDufficulty1::shuffleDeck()
{
    QList<Card*> newDeck;
    while(deck.length() > 0)
...
void UnoLiteDufficulty1::showArrangeHands()
{
    hideAll();
    Card *c;
    int i = 0;
...
void UnoLiteDufficulty1::cardClick(Card *c)
{
...
void UnoLiteDufficulty1::computerMove()
{
    if (stack.length() > 22)
    {
        for (int i = 0; i < 20; ++i)
...
Colour UnoLiteDufficulty1::calc4Colour()
{
    int nR, nG, nY, nB;
    nR = nG = nY = nB = 0;
    QListIterator<Card*> computerHandIterator(computerHand);
...
void UnoLiteDufficulty1::debug(QString s)
{
