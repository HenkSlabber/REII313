...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Card_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Card_t qt_meta_stringdata_Card = {
    {
QT_MOC_LITERAL(0, 4), // "Card"
QT_MOC_LITERAL(5, 11), // "iWasClicked"
QT_MOC_LITERAL(17, 0), // ""
QT_MOC_LITERAL(18, 5) // "Card*"

    },
    "Card\0iWasClicked\0\0Card*"
};
...
void Card::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->iWasClicked((*reinterpret_cast< std::add_pointer_t<Card*>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Card::iWasClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Card::staticMetaObject = { {
    ...
    qt_meta_stringdata_Card.offsetsAndSize,
    qt_meta_data_Card,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Card_t
, QtPrivate::TypeAndForceComplete<Card, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<Card *, std::false_type>
...
// SIGNAL 0
void Card::iWasClicked(Card * _t1)
{
