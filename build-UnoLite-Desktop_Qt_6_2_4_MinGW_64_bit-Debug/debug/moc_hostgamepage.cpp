...
#include <memory>
#include "../../../../../Desktop/Ingenieurswese/4de Jaar/INGB 318/UnoLite/UnoLite/hostgamepage.h"
...
void hostgamepage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<hostgamepage *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (hostgamepage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&hostgamepage::BackButtonPressed)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject hostgamepage::staticMetaObject = { {
    ...
    qt_meta_stringdata_hostgamepage.offsetsAndSize,
...
// SIGNAL 0
void hostgamepage::BackButtonPressed()
{
