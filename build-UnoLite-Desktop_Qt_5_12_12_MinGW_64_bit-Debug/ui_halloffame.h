...
public:
    ...
    {
        halloffame->setWindowTitle(QApplication::translate("halloffame", "Form", nullptr));
        HallOfFameBackBtn->setText(QApplication::translate("halloffame", "PushButton", nullptr));
    } // retranslateUi
